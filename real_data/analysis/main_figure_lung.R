# organ_type = "Lung" # Breast, Lung, Colorectal
# path = "/Users/azadsadr/"
...
clusters_to_remove = c("G8","G12","G13")
...
panelE = plots$denovo_sig2 + xlab("Doublet bases") +
  theme(axis.text.x=element_text(angle=90, size=3), axis.text.y=element_text(),
        legend.position="right") +
  scale_y_continuous(label=function(x) abs(x))
...
ggsave(paste0("paper/figure4/", tolower(organ_type), ".pdf"), plot=a, width=210, height=297, units="mm")
